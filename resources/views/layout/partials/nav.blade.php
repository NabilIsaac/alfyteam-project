<nav class="px-2 py-3 bg-white border-gray-200 rounded sm:px-4 playfair">
    ...
    <div class="flex md:order-2">
      ...
      <button data-collapse-toggle="mobile-menu-3" id="hamburger"  type="button" class="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mobile-menu-3" aria-expanded="false">
    ...
    <div class="hidden toggle" id="mobile-menu-3">
      <div class="pt-2 pb-3 m-1 space-y-1 text-black rounded-xl bg-primary">
        <a class="block py-1 text-base font-medium" href="#">Group trips</a>
        <a class="block py-1 text-base font-medium" href="#">Past trips</a>
        <a class="block py-1 text-base font-medium" href="#">Past trips & reviews</a>
        <a class="block py-1 text-base font-medium" href="#">About us</a>
        <a class="block py-1 text-base font-medium" href="#">FAQs</a>
        <a class="block py-1 text-base font-medium" href="#">Blog</a>
        <a class="block py-1 text-base font-medium" href="#">Contact us</a>
        <a href="#" class="flex items-center justify-center w-8 h-8 p-2 border border-black rounded-lg">
          <img src="{{ asset('assets/imgs/magnifying-glass-solid.svg') }}" class="w-7 h-7 " alt="">
        </a>
        <a href="#" class="flex items-center justify-center w-20 h-8 p-2 border border-black rounded-lg">
